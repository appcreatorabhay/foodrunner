...
import com.anujandankit.abhayfoodrunner.adapter.OrderHistoryRecyclerViewAdapter
import com.anujandankit.abhayfoodrunner.model.OrderDetails
...
class OrderHistoryFragment : Fragment() {
    ...
    lateinit var recyclerAdapter: OrderHistoryRecyclerViewAdapter
                                ...
                                if (success) {
                                    ...
                                    if (data.length() == 0) {
                                        ...
                                        for (i in 0 until data.length()) {
                                            ...
                                            recyclerAdapter = OrderHistoryRecyclerViewAdapter(
                                                activity as Context,
                                                orderHistoryList
                                            )
